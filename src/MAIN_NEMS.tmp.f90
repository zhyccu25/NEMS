...
!-----------------------------------------------------------------------
!
!#if defined ("(zrb) Thu Dec 10 09:54:09 CST 2020 r2fdfde2b49b2 https://github.com/GM-Ling/NEMS.git") && defined (2020) && defined (345)
!      if (mype==0) call w3tagb('NEMS '//"(zrb) Thu Dec 10 09:54:09 CST 2020 r2fdfde2b49b2 https://github.com/GM-Ling/NEMS.git",                       &
!                               2020, 345, 0000, 'NEMS')
!#else
...
!
      CALL ESMF_ConfigGetAttribute(config = CF_MAIN                     &
                                  ...
                                  ,label  = 'RUN_CONTINUE:'             &
                                  ,rc     = RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=513, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
        CALL ESMF_ConfigGetAttribute(config = CF_MAIN                   &
                                    ...
                                    ,label  = 'HH_START:'               &
                                    ,rc     = RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=532, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
!
        CALL ESMF_ConfigGetAttribute(config = CF_MAIN                   &
                                    ,value  = hh_final                  &
                                    ,label  = 'HH_FINAL:'               &
                                    ,rc     = RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=538, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
...
!
        CALL ESMF_TimeIntervalSet(timeInterval = RUNDURATION            &
                                 ,h            = NHOURS_FCST            &
                                 ,rc           = RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=551, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
!
        CALL ESMF_ClockGet(clock    = CLOCK_MAIN                        &
                          ,currTime = CURRTIME                          &
                          ,rc       = rc)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=556, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
!
...
!
        CALL ESMF_ClockSet(clock       = CLOCK_MAIN                     &
                          ...
                          ,currTime    = CURRTIME                       &
                          ,rc          = RC)
        if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=564, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
      END IF
!
...
!
      CALL ESMF_GridCompFinalize(gridcomp   =NEMS_GRID_COMP             &  !<-- The NEMS component
                                ...
                                ,userRc     =RC_USER                    &
                                ,rc         =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=585, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
      if (ESMF_LogFoundError(RC_USER, msg="Aborting NEMS", line=586, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_ClockDestroy(clock=CLOCK_MAIN                           &
                            ,rc   =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=600, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
!-----------------------------------------------------------------------
...
!
      CALL ESMF_ConfigDestroy(config=CF_MAIN                            &
                             ,rc    =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=614, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
      ...
      CALL ESMF_StateDestroy(state=NEMS_IMP_STATE                       &
                            ,rc   =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=624, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
!
      CALL ESMF_StateDestroy(state=NEMS_EXP_STATE                       &
                            ,rc   =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=628, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
!
! ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~ ~
...
!
      CALL ESMF_GridCompDestroy(gridcomp=NEMS_GRID_COMP                 &
                               ,rc      =RC)
      if (ESMF_LogFoundError(RC, msg="Aborting NEMS", line=638, file="MAIN_NEMS.F90")) call ESMF_Finalize(endflag=ESMF_END_ABORT)
